...
class Controller(object):
    ...
    def session_start(self):
        # cookies = {"cookie1":  ""}
        cookies = {"cookie1": "Hello world"}
        # client = aiohttp.ClientSession(cookie_jar=aiohttp.DummyCookieJar)
        client = aiohttp.ClientSession(cookies=cookies)
        self._http_client = client
        _LOGGER.debug(f"Number of cookies 1st: {len(self._http_client.cookie_jar)}")
